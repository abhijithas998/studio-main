...
export const metadata: Metadata = {
  title: 'Joyeux – Wedding Planner & Events',
  description: 'Memories made for you. We make your special day truly memorable with event planning, catering, decoration, and more.',
};
